...
const int cServoPin          = 42;                 // GPIO pin for servo motor
...
if (g-r>=2&&g-b>=2&&c<50)
{
  servoPos = map(0, 0, 4095, 0, 180);         // scale it into servo range 0 to 180 degrees
}
else if(30>=c||c>=35)
{
  servoPos = map(4095, 0, 4095, 0, 180);         // scale it into servo range 0 to 180 degrees
}

else
{
  servoPos = map(2047.5, 0, 4095, 0, 180);         // scale it into servo range 0 to 180 degrees
}
